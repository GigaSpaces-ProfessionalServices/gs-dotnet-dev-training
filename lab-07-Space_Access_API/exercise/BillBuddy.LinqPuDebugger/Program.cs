...
namespace BillBuddy.PuDebugger
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press any key to run Linq Payment Feeder.");
            Console.ReadKey();

            var paymentFeederPath = Path.GetFullPath(Path.Combine(Utility.DeploymentPath, "BillBuddy.LinqPaymentFeeder"));
