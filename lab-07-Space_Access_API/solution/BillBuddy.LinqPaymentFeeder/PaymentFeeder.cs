...
namespace BillBuddy.LinqPaymentFeeder
{
    public class PaymentFeeder
    {
        ...
        public PaymentFeeder()
        {
            ...
            var userQuery = from u in _spaceProxy.Query<User>()
                            where u.Name != null
                            select u;
            ...
            merchantCount = (from m in _spaceProxy.Query<Merchant>()
                             where m.Name != null
                             select m)
                             .Count();
        ...
        public void CreatePayment()
        {
            ...
            var merchantQuery = from m in _spaceProxy.Query<Merchant>()
                                where m.MerchantAccountId == merchantId
                                select m;

            merchant = merchantQuery.SingleOrDefault();
