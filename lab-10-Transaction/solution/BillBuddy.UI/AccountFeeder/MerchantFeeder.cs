...
namespace BillBuddy.UI.AccountFeeder
{
    ...
    public class MerchantFeeder
    {
        ...
        public void Run()
        {
            ...
            ITransactionManager transactionManager = GigaSpacesFactory.CreateDistributedTransactionManager();

            foreach (string merchantName in Config.MerchantList)
            {
                CreateMerchant(merchantAccountId, merchantName, transactionManager);
        ...
        private void CreateMerchant(int merchantAccountId, string merchantName, ITransactionManager transactionManager)
        {
